...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/mnt/ffmpeg-android-maker/build/ffmpeg/arm64-v8a --enable-cross-compile --target-os=android --arch=aarch64 --sysroot=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/sysroot --cc=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang --cxx=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang++ --ld=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang --ar=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar --as=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang --nm=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm --ranlib=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib --strip=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip --extra-cflags='-O3 -fPIC -I/mnt/ffmpeg-android-maker/build/external/arm64-v8a/include' --extra-ldflags='-L/mnt/ffmpeg-android-maker/build/external/arm64-v8a/lib ' --enable-shared --disable-static --pkg-config=/usr/bin/pkg-config --enable-gpl --enable-libx264
...
INTRINSICS=neon
EXTERN_PREFIX=
CC=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang
CXX=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang++
AS=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang
OBJCC=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang
LD=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang
DEPCC=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ar
NM_CMD=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-nm
RANLIB=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-ranlib
STRIP=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/llvm-strip
STRIPTYPE=direct
NVCC=clang
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/sysroot -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -O3 -fPIC -I/mnt/ffmpeg-android-maker/build/external/arm64-v8a/include -std=c11 -fPIE -fomit-frame-pointer -fPIC -pthread -I/mnt/ffmpeg-android-maker/build/external/arm64-v8a/include -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -O3 -fPIC -I/mnt/ffmpeg-android-maker/build/external/arm64-v8a/include -fPIC -g -Qunused-arguments
...
DLLTOOL=
WINDRES=windres
DEPWINDRES=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android24-clang
DOXYGEN=doxygen
LDFLAGS= -L/mnt/ffmpeg-android-maker/build/external/arm64-v8a/lib  --sysroot=/root/android-sdk/ndk/22.0.7026061/toolchains/llvm/prebuilt/linux-x86_64/sysroot -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -Qunused-arguments
LDEXEFLAGS= -fPIE -pie
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -lz -L/mnt/ffmpeg-android-maker/build/external/arm64-v8a/lib -lx264 -lm
